...
if($lastInsertId)
{
$_SESSION['msg']="Danh sách sách hoàn thành";
...
<head>
    ...
    <title>Quản lý hệ thống thư viện trực tuyến | Thêm sách</title>
...
<p class="help-block">Số ISBN là số sách đạt tiêu chuẩn quốc tế.Số ISBN phải là duy nhất</p>
</div>
