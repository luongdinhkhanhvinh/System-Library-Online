...
<head>
    ...
    <title>Quản lý hệ thống thư viện trực tuyến | Quản lý mượn sách</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Chỉnh sửa</button> 
