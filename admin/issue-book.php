...
if($lastInsertId)
{
$_SESSION['msg']="Sách phát hành thành công";
...
<head>
    ...
    <title>Quản lý hệ thống thư viện trực tuyến | Sách mượn mới</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Sách mượn mới</h4>
...
<div class="form-group">
<label>Số ISBN của sách<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Sách mượn </button>
