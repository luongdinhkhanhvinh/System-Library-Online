...
if($lastInsertId)
{
echo '<script>alert("Bạn đã đăng ký thành công và id học sinh của bạn là  "+"'.$StudentId.'")</script>';
}
else 
{
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Hệ thống quản lý thư viện trực tuyến | Sinh viên đăng nhập</title>
